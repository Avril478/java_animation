 ...
 *  Also contains start and stop buttons that starts animation and stops animation respectively,including GUI.
 *  YOUR UPI: kwan380 429862422  KAI WANG
 *  ============================================================================================
 */
...
public class A1 extends JFrame {
	...
	* @return toolsPanel		the Panel */
	public JPanel setUpToolsPanel() {
		...
		ImageIcon spinButtonIcon = createImageIcon("spinningcircle.gif");
		ImageIcon starsMapButtonIcon = createImageIcon("starsmap.gif");
		ImageIcon heartButtonIcon = createImageIcon("heart.gif");
		shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {recangletButtonIcon,squareButtonIcon,ellipseButtonIcon, starsMapButtonIcon, spinButtonIcon,heartButtonIcon} );
