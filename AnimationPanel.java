/*
 *    ==========================================================================================
 *    AnimationPanel.java : Extends JComponent implements Runnable interface . Moves shapes around on the screen according to different paths.
...
public class AnimationPanel extends JComponent implements Runnable {
	private String currentMessage = "CS230";  // the current message stored
    ...
    protected void createNewShape(int x, int y) {
        ...
        case 0: {
            ...
            shapes.add(new MovingSquare(x, y, currentWidth > currentHeight? currentHeight:currentWidth, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentMessage, currentPath));
            break;
        } case 2: {
        ...
        case 4: {
            shapes.add(new MovingSpinningCircle(x, y, currentWidth > currentHeight? currentHeight : currentWidth, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentMessage, currentPath));
            break;
        }
        case 5: {
            shapes.add(new MovingHeart(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentMessage, currentPath));
            break;
        }
    ...
    /**
     * Display a list of sorted movingshape objects
     * @return ArrayList<MovingShape>
     */
    ...
    /**
     * Get the current message stored in the AnimationPanel class
     * @return String
     */
    public String getCurrentMessage() { return this.currentMessage; } //complete this
    
    /**
     * Set the current message stored in the AnimationPanel class
     * @param s String the current message
     */
